    ...
    <main className="min-h-screen bg-gray-950 text-white">
      <nav className="border-b border-gray-800 px-6 py-4">
        <div className="max-w-3xl mx-auto">
          <Link href="/" className="text-sm text-gray-400 hover:text-gray-200">← トップに戻る</Link>
        </div>
      </nav>
      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        ...
        <section className="space-y-8 text-sm text-gray-300 leading-relaxed">
          <div>
            ...
            <p>本サービス「副業クリッカー」（以下「本サービス」）は、ポッコリラボが運営するWebサービスです。</p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>Cookie（ゲームセーブデータ・プレミアム状態の管理に使用）</li>
          ...
          <div>
            ...
            <p>本サービスでは、ゲームの進行状況およびプレミアム状態を管理するためにCookieを使用しています。ブラウザの設定によりCookieを無効にすることができますが、ゲームデータが保存されなくなります。</p>
          </div>
          ...
          <div>
            <h2 className="font-bold text-white mb-2">7. ポリシーの変更</h2>
            <p>本ポリシーは予告なく変更する場合があります。変更後は本ページに掲載した時点で効力を生じます。</p>
          </div>

          <div>
            <h2 className="font-bold text-white mb-2">8. 事業者情報</h2>
